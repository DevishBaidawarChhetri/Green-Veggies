                        ...
                        <div class="card card-rad pt-4 mx-auto">
                            ...
                            <div class="card-body">
                                ...
                                <span class="clearfix">
                                    ...
                                    <a href="{{ url('/addedProducts',$product->id) }}/{{__('delete')}}" class="btn btn-danger float-right" style="border-radius: 0; border: none; width: 49%;" onclick="return confirm ('Are you sure you want to delete?');"><i class="fas fa-trash-alt"></i> Delete</a>
                                </span>
                            </div>
                        </div>
                    </div>
