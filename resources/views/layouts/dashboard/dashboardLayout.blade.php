...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="{{ url('/') }}" class="brand-link">
            <img src="{{asset('/images/logo.png')}}" alt="Tech wolves Logo" class="brand-image img-circle elevation-3" style="box-shadow: 0 0 0 #ddd !important; border-radius: 0;">
            <span class="brand-text font-weight-light">Green Veggies</span>
        </a>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2020 <a href="https://devish.com.np" target="_blank" class="text-success">Green Veggies</a>.</strong>
        All rights reserved.
