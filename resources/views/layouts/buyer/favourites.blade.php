                                ...
                                <div class="card card-rad pt-4 mx-auto">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <span class="clearfix">
                                            ...
                                            <a href="{{ url('/favourites',$favourite->fav_id) }}" style=" border-radius: 0;" class="btn btn-danger float-right" onclick="return confirm ('Are you sure you want to remove?');"><i class="fas fa-trash-alt"></i> Remove</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
