                ...
                <div class="row">
                    ...
                    <div class="jumbotron pb-2">
                        ...
                        <p class="lead float-right mt-4">
                            <a class="btn btn-primary" style="border-radius: 0;" href="mailto: {{$contact->email}}?subject=Hello from green veggies.">Reply <i class="fas fa-reply"></i></a>
                            <a class="btn btn-danger text-light" style="border-radius: 0;" href="{!! url('/deleteContacts', $contact->id) !!}" onclick="return confirm('Are you sure you want to delete?')">Delete <i class="fas fa-trash-alt"></i></a>
                        </p>
                    </div>
                    @endforeach
                    {{--Pagination Begins--}}
