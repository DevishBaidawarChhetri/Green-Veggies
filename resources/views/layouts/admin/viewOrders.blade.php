                        ...
                        @foreach($orders as $order)
                            <table class="table table-bordered table-striped table-responsive" style="margin: 30px 0 60px;">
                                ...
                                <tr class="text-center">
                                    <th colspan="7"><h2>Approve Orders <i class="fab fa-opencart"></i></h2></th>
                                </tr>
                                <tr class="text-center">
                                    <th scope="col">S.N</th>
                                        ...
                                        <td>
                                            <strong class="text-capitalize">
                                                @if($order->status === 'processing')
                                                    <p class="badge badge-warning bg-orange" style="border-radius: 0; color: #fff !important;">{{$order->status}}</p>
                                                @endif
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row" colspan="2">
                                            <div class="tooltip-wrapper">
                                                @if($order->status == 'delivered')
                                                    <button href="{{url('/viewBill')}}/{{$order->id}}" class="btn btn-danger float-right" style="border-radius: 0; border: none;" disabled><i class="fas fa-receipt"></i>&nbsp;&nbsp;Product Delivered</button>
                                                @else
                                                    <button class="btn btn-primary float-right" style="border-radius: 0; border: none;" >
